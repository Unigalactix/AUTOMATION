...
Body:
@copilot /fix This issue **PROJ-123: Create REST API for user management**

Create REST API for user management

Read the whole repository first and then Please generate a CI / CD pipeline file based on this repo using the format below(ignore if already exists and working):
```yaml
name: CI Pipeline - ...
...
```
